...
public class Onion extends Fragment {
    ...
    private static final String COUNTKEY="count3";

    private int clickCount = 0;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.onion, container, false);
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clickCount++;
                String onion="洋蔥圈";
                Intent intent = new Intent("com.example.order_system.POTATO_SELECTED3");
                intent.putExtra("onion", onion);
                intent.putExtra("count3", clickCount);
