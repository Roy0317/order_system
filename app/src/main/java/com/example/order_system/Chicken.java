...
public class Chicken extends Fragment {
    ...
    private static final String COUNTKEY="count2";

    private int clickCount = 0;
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.chicken, container, false);
        TextView textView=view.findViewById(R.id.text13);
        ...
        textView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                clickCount++;
                String chicken="雞塊";
                Intent intent = new Intent("com.example.order_system.POTATO_SELECTED2");
                intent.putExtra("chicken", chicken);
                intent.putExtra("count2", clickCount);
